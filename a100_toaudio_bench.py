...
def main():
    ...
    json.dump(out, open("a100_toaudio_full824.json", "w"), indent=2)
    sha = hashlib.sha256(open("a100_toaudio_full824.json", "rb").read()).hexdigest()
    open("a100_toaudio_full824.json.sha256", "w").write(f"{sha}  a100_toaudio_full824.json\n")
